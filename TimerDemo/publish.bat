...
plink -ssh -pw raspberry pi@192.168.2.17 "sudo killall -s SIGKILL dotnet /home/pi/Desktop/rpitest/MicroTimerConsoleDemo.dll"
...
plink -pw raspberry pi@192.168.2.17 "dotnet /home/pi/Desktop/rpitest/MicroTimerConsoleDemo.dll"
