...
namespace Walter.Timers.Windows
{
  internal static class WindowsNativeMethods
  {
    ...
    public static extern uint TimeSetEvent(uint msDelay, uint msResolution, MultimediaTimerCallback callback,
    ...
    public static extern bool CreateTimerQueueTimer(out IntPtr newTimer, IntPtr timerQueue, TimerDelegate callback,
